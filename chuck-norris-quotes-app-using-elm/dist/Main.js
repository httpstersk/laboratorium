...
var _user$project$Main$fetchRandomQuote = _evancz$elm_http$Http$getString(_user$project$Main$randomQuoteUrl);
var _user$project$Main$Model = function (a) {
	return {quote: a};
};
var _user$project$Main$HttpError = function (a) {
	return {ctor: 'HttpError', _0: a};
};
var _user$project$Main$FetchQuoteSuccess = function (a) {
	return {ctor: 'FetchQuoteSuccess', _0: a};
};
var _user$project$Main$fetchRandomQuoteCmd = A3(_elm_lang$core$Task$perform, _user$project$Main$HttpError, _user$project$Main$FetchQuoteSuccess, _user$project$Main$fetchRandomQuote);
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Main$GetQuote)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Grab a quote!')
							]))
					])),
				A2(
